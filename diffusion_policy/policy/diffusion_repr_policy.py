...
from diffusion_policy.model.vision.multimodal_obs_encoder import MultiModalObsEncoder


class DiffusionUnetReprPolicy(BaseImagePolicy):
    def __init__(self,
                 shape_meta: dict,
    ...
    def conditional_sample(self,
        ...
        trajectory = torch.randn(  # 全噪声的trajectory
