...
from diffusion_policy.taming.models.vqgan import VQModel, WOVQModel
from diffusion_policy.dataset.representation_wrapper import RepresentationWrapper
from diffusion_policy.taming.logging_util import *
...
class TrainVqvaeRepresentationWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf):
        ...
        default_callbacks_cfg["periodic_checkpoint"] = {
            "target": "diffusion_policy.taming.logging_util.PeriodicCheckpointCallback",
            "params": {
                "ckptdir": ckptdir,
                "save_interval": 1,  
                "save_last_n": 3,   
