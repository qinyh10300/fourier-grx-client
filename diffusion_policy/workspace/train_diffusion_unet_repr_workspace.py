...
from diffusion_policy.policy.diffusion_repr_policy import DiffusionUnetReprPolicy
...
class TrainDiffusionUnetImageWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetReprPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetReprPolicy = None
