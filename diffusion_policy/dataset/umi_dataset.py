...
class UmiDataset(BaseDataset):
    ...
    def get_normalizer(self, **kwargs) -> LinearNormalizer:  # 哪里用了？
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        for key in self.rgb_keys:
            ...
            obs_dict[key] = np.moveaxis(data[key], -1, 1).astype(np.float32) / 255.  # normal过
            # T,C,H,W
            del data[key]
        ...
        for robot_id in range(self.num_robot):
            ...
            for other_robot_id in range(self.num_robot):
                ...
                rel_obs_pose_mat = convert_pose_mat_rep( #左手to右手
                    pose_mat,
        ...
        for robot_id in range(self.num_robot):
            ...
            rel_obs_pose_mat = convert_pose_mat_rep( # 对的
                pose_mat,
